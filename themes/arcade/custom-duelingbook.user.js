// ==UserScript==
// @name         Custom DB — Arcade CRT
// @description  Custom DB themed with the Arcade CRT asset pack — Phosphor and scanlines. Blocky frames, pixel reticles, cabinet colours.
// @version      1.1.72.1
// @author       Killburne
// @license		 MIT
// @namespace    https://github.com/Jazzzzzyyyyy/my-custom-db-theme#arcade
// @homepageURL  https://github.com/Jazzzzzyyyyy/my-custom-db-theme
// @updateURL  https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/custom-duelingbook.user.js
// @downloadURL  https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/custom-duelingbook.user.js
...
$(document).ready(function() {
    ...
    function getConfigFields() {
        const config = {
            ...
            backgroundUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/background.svg'
            },
            ...
            deckZoneImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/field_decks2.svg'
            },
            fieldZoneImageUrl: {
                label: 'Field zone image url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/field_zones2.svg'
            },
            deckZoneImageUrlMr3: {
            ...
            phaseButtonBackgroundImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/button_bg.svg'
            },
            phaseButtonRedImageUrl: {
                label: 'Phase Button Red Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/button_red.svg'
            },
            phaseButtonRedActiveImageUrl: {
                label: 'Phase Button Red Active Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/button_red_lit.svg'
            },
            phaseButtonBlueImageUrl: {
                label: 'Phase Button Blue Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/button_blue.svg'
            },
            phaseButtonBlueActiveImageUrl: {
                label: 'Phase Button Blue Active Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/button_blue_lit.svg'
            },
            turnButtonBackgroundImageUrl: {
                label: 'Turn Button Background Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/turn_background.svg'
            },
            turnButtonRedImageUrl: {
                label: 'Turn Button Red Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/turn_red.svg'
            },
            turnButtonBlueImageUrl: {
                label: 'Turn Button Blue Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/turn_blue.svg'
            },
            turnButtonYellowImageUrl: {
                label: 'Turn Button Yellow Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/turn_yellow.svg'
            },
            turnButtonGreenImageUrl: {
                label: 'Turn Button Green Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/turn_green.svg'
            },
            turnButtonGlowImageUrl: {
                label: 'Turn Button Glow Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/white_glow.svg'
            },
            counterButtonImageUrl: {
                label: 'Counter Button Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/counter.svg'
            },
            counterButtonGlowImageUrl: {
                label: 'Counter Button Glow Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/counter_glow.svg'
            },
            ...
            profileRedBorderImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/profile_bg_red.svg'
            },
            profileBlueBorderImageUrl: {
                label: 'Profile Border Blue Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/profile_bg_blue.svg'
            },
            deckConstructorBackgroundImage: {
                label: 'Deck Constructor Background Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/deck_constructor.svg'
            },
            deckConstructorSearchImage: {
                label: 'Deck Constructor Search Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/search.svg'
            },
            ...
            attackSwordImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/laser_sword.svg'
            },
            fullArtCards: {
        ...
        for (const button of overrideButtonImages) {
            for (const state of buttonStates) {
                config[`${button.identifier}_${state}`] = {
                    ...
                    type: 'text',
                    size: 300,
                    default: `https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/${button.imgName}_${state}.svg`
                };
            }
        }
    ...
    function migrateNewUrl() {
        const migrations = [
            ...
            },
            {
                ...
                new: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/background.svg'
            },
            {
                key: 'okSoundUrl',
    ...
    const NEON_THEME = {"ink":"#0b0f0b","panel":"#111811","line":"#264026","text":"#ddffdd","p1":"#ff5555","p2":"#55ffff","a1":"#ffee55","a2":"#55ff55","a1soft":"#fff5a1","dim1":"#5e4532","dim2":"#32715e"};
    ...
    function setDarkMode() {
        ...
        .cell.cell1 { background-image: url('https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/cell4.svg'); color: #efeff1 !important; }
        .cell.cell1.selected { background-image: url('https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/cell_sel.svg'); color: #efeff1 !important; }
    ...
    function adjustElementsForDarkmode() {
        const comboboxArrowImageUrl = 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/combobox_arrow.svg';
        const radioButtonCheckImageUrl = 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/radio.svg';
        const checkboxCheckImageUrl = 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/arcade/assets/check.svg';
