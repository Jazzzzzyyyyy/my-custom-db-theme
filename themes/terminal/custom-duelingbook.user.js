// ==UserScript==
// @name         Custom DB — Duel Terminal
// @description  Custom DB themed with the Duel Terminal asset pack — Corroded industrial. Cut corners, hazard amber, patina and rust.
// @version      1.1.72.1
// @author       Killburne
// @license		 MIT
// @namespace    https://github.com/Jazzzzzyyyyy/my-custom-db-theme#terminal
// @homepageURL  https://github.com/Jazzzzzyyyyy/my-custom-db-theme
// @updateURL  https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/custom-duelingbook.user.js
// @downloadURL  https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/custom-duelingbook.user.js
...
$(document).ready(function() {
    ...
    function getConfigFields() {
        const config = {
            ...
            backgroundUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/background.svg'
            },
            ...
            deckZoneImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/field_decks2.svg'
            },
            fieldZoneImageUrl: {
                label: 'Field zone image url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/field_zones2.svg'
            },
            deckZoneImageUrlMr3: {
            ...
            phaseButtonBackgroundImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/button_bg.svg'
            },
            phaseButtonRedImageUrl: {
                label: 'Phase Button Red Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/button_red.svg'
            },
            phaseButtonRedActiveImageUrl: {
                label: 'Phase Button Red Active Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/button_red_lit.svg'
            },
            phaseButtonBlueImageUrl: {
                label: 'Phase Button Blue Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/button_blue.svg'
            },
            phaseButtonBlueActiveImageUrl: {
                label: 'Phase Button Blue Active Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/button_blue_lit.svg'
            },
            turnButtonBackgroundImageUrl: {
                label: 'Turn Button Background Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/turn_background.svg'
            },
            turnButtonRedImageUrl: {
                label: 'Turn Button Red Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/turn_red.svg'
            },
            turnButtonBlueImageUrl: {
                label: 'Turn Button Blue Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/turn_blue.svg'
            },
            turnButtonYellowImageUrl: {
                label: 'Turn Button Yellow Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/turn_yellow.svg'
            },
            turnButtonGreenImageUrl: {
                label: 'Turn Button Green Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/turn_green.svg'
            },
            turnButtonGlowImageUrl: {
                label: 'Turn Button Glow Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/white_glow.svg'
            },
            counterButtonImageUrl: {
                label: 'Counter Button Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/counter.svg'
            },
            counterButtonGlowImageUrl: {
                label: 'Counter Button Glow Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/counter_glow.svg'
            },
            ...
            profileRedBorderImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/profile_bg_red.svg'
            },
            profileBlueBorderImageUrl: {
                label: 'Profile Border Blue Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/profile_bg_blue.svg'
            },
            deckConstructorBackgroundImage: {
                label: 'Deck Constructor Background Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/deck_constructor.svg'
            },
            deckConstructorSearchImage: {
                label: 'Deck Constructor Search Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/search.svg'
            },
            ...
            attackSwordImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/laser_sword.svg'
            },
            fullArtCards: {
        ...
        for (const button of overrideButtonImages) {
            for (const state of buttonStates) {
                config[`${button.identifier}_${state}`] = {
                    ...
                    type: 'text',
                    size: 300,
                    default: `https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/${button.imgName}_${state}.svg`
                };
            }
        }
    ...
    function migrateNewUrl() {
        const migrations = [
            ...
            },
            {
                ...
                new: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/background.svg'
            },
            {
                key: 'okSoundUrl',
    ...
    const NEON_THEME = {"ink":"#12100d","panel":"#1d1a15","line":"#3d3529","text":"#e7e2d6","p1":"#e2570c","p2":"#4d9c73","a1":"#eab308","a2":"#a8a29e","a1soft":"#f3d577","dim1":"#673d21","dim2":"#414f3c"};
    ...
    function setDarkMode() {
        ...
        .cell.cell1 { background-image: url('https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/cell4.svg'); color: #efeff1 !important; }
        .cell.cell1.selected { background-image: url('https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/cell_sel.svg'); color: #efeff1 !important; }
    ...
    function adjustElementsForDarkmode() {
        const comboboxArrowImageUrl = 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/combobox_arrow.svg';
        const radioButtonCheckImageUrl = 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/radio.svg';
        const checkboxCheckImageUrl = 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/terminal/assets/check.svg';
