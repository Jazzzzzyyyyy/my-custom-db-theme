// ==UserScript==
// @name         Custom DB — Millennium
// @description  Custom DB themed with the Millennium asset pack — Carved sandstone and gold leaf. Sun-disc reticles, lapis and carnelian.
// @version      1.1.72.1
// @author       Killburne
// @license		 MIT
// @namespace    https://github.com/Jazzzzzyyyyy/my-custom-db-theme#millennium
// @homepageURL  https://github.com/Jazzzzzyyyyy/my-custom-db-theme
// @updateURL  https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/custom-duelingbook.user.js
// @downloadURL  https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/custom-duelingbook.user.js
...
$(document).ready(function() {
    ...
    function getConfigFields() {
        const config = {
            ...
            backgroundUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/background.svg'
            },
            ...
            deckZoneImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/field_decks2.svg'
            },
            fieldZoneImageUrl: {
                label: 'Field zone image url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/field_zones2.svg'
            },
            deckZoneImageUrlMr3: {
            ...
            phaseButtonBackgroundImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/button_bg.svg'
            },
            phaseButtonRedImageUrl: {
                label: 'Phase Button Red Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/button_red.svg'
            },
            phaseButtonRedActiveImageUrl: {
                label: 'Phase Button Red Active Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/button_red_lit.svg'
            },
            phaseButtonBlueImageUrl: {
                label: 'Phase Button Blue Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/button_blue.svg'
            },
            phaseButtonBlueActiveImageUrl: {
                label: 'Phase Button Blue Active Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/button_blue_lit.svg'
            },
            turnButtonBackgroundImageUrl: {
                label: 'Turn Button Background Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/turn_background.svg'
            },
            turnButtonRedImageUrl: {
                label: 'Turn Button Red Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/turn_red.svg'
            },
            turnButtonBlueImageUrl: {
                label: 'Turn Button Blue Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/turn_blue.svg'
            },
            turnButtonYellowImageUrl: {
                label: 'Turn Button Yellow Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/turn_yellow.svg'
            },
            turnButtonGreenImageUrl: {
                label: 'Turn Button Green Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/turn_green.svg'
            },
            turnButtonGlowImageUrl: {
                label: 'Turn Button Glow Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/white_glow.svg'
            },
            counterButtonImageUrl: {
                label: 'Counter Button Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/counter.svg'
            },
            counterButtonGlowImageUrl: {
                label: 'Counter Button Glow Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/counter_glow.svg'
            },
            ...
            profileRedBorderImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/profile_bg_red.svg'
            },
            profileBlueBorderImageUrl: {
                label: 'Profile Border Blue Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/profile_bg_blue.svg'
            },
            deckConstructorBackgroundImage: {
                label: 'Deck Constructor Background Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/deck_constructor.svg'
            },
            deckConstructorSearchImage: {
                label: 'Deck Constructor Search Image Url',
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/search.svg'
            },
            ...
            attackSwordImageUrl: {
                ...
                type: 'text',
                size: 300,
                default: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/laser_sword.svg'
            },
            fullArtCards: {
        ...
        for (const button of overrideButtonImages) {
            for (const state of buttonStates) {
                config[`${button.identifier}_${state}`] = {
                    ...
                    type: 'text',
                    size: 300,
                    default: `https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/${button.imgName}_${state}.svg`
                };
            }
        }
    ...
    function migrateNewUrl() {
        const migrations = [
            ...
            },
            {
                ...
                new: 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/background.svg'
            },
            {
                key: 'okSoundUrl',
    ...
    const NEON_THEME = {"ink":"#0d0a06","panel":"#1a140c","line":"#4a3a1c","text":"#f2e4c4","p1":"#c8452f","p2":"#2f6bc8","a1":"#e8b64c","a2":"#3aa89b","a1soft":"#f2d69c","dim1":"#6a3c20","dim2":"#424648"};
    ...
    function setDarkMode() {
        ...
        .cell.cell1 { background-image: url('https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/cell4.svg'); color: #efeff1 !important; }
        .cell.cell1.selected { background-image: url('https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/cell_sel.svg'); color: #efeff1 !important; }
    ...
    function adjustElementsForDarkmode() {
        const comboboxArrowImageUrl = 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/combobox_arrow.svg';
        const radioButtonCheckImageUrl = 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/radio.svg';
        const checkboxCheckImageUrl = 'https://raw.githubusercontent.com/Jazzzzzyyyyy/my-custom-db-theme/main/themes/millennium/assets/check.svg';
